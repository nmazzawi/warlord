...
export const CIVS: Record<string, CivDef> = {
  outlaw: {
    ...
    troops: [
      { id: "outlaw_brigand", name: "Brigand", role: "line",
      ...
      { id: "outlaw_poacher", name: "Poacher", role: "specialist",
      ...
      { id: "outlaw_horsethief", name: "Horse-thief", role: "specialist",
      ...
      { id: "outlaw_brokendruzhinnik", name: "Broken Druzhinnik", role: "elite",
  ...
  rome: {
    ...
    troops: [
      { id: "rome_auxiliary", name: "Auxiliary", role: "line",
        attack: 8, defense: 2, speed: 150, evasion: 2, range: 0,
        hp: 50, cost: 32, wage: 2,
      ...
      { id: "rome_legionary", name: "Legionary", role: "elite",
      ...
      { id: "rome_velite", name: "Velite", role: "specialist",
      ...
      { id: "rome_centurion", name: "Centurion", role: "specialist",
  ...
  greece: {
    ...
    troops: [
      { id: "greece_hoplite", name: "Hoplite", role: "line",
      ...
      { id: "greece_epilektos", name: "Epilektos", role: "elite",
      ...
      { id: "greece_sphendonetes", name: "Sphendonetes", role: "specialist",
  ...
  japan: {
    ...
    troops: [
      { id: "japan_ashigaru", name: "Ashigaru", role: "line",
        attack: 8, defense: 2, speed: 150, evasion: 2, range: 0,
        hp: 50, cost: 32, wage: 2,
      ...
      { id: "japan_samurai", name: "Samurai", role: "elite",
      ...
      { id: "japan_ninja", name: "Ninja", role: "specialist",
      ...
      { id: "japan_sohei", name: "Sohei", role: "specialist",
  ...
  china: {
    ...
    troops: [
      { id: "china_fubing", name: "Fubing", role: "line",
      ...
      { id: "china_nushou", name: "Nushou", role: "specialist",
      ...
      { id: "china_gushou", name: "Gushou", role: "specialist",
        attack: 10, defense: 4, speed: 168, evasion: 14, range: 0,
        hp: 54, cost: 82, wage: 5,
      ...
      { id: "china_horsecutter", name: "Horse-Cutter", role: "elite",
  ...
  mongolia: {
    ...
    troops: [
      { id: "mongolia_stepperider", name: "Steppe Rider", role: "line",
      ...
      { id: "mongolia_lancer", name: "Lancer", role: "specialist",
      ...
      { id: "mongolia_kharuul", name: "Kharuul", role: "specialist",
        attack: 9, defense: 2, speed: 195, evasion: 14, range: 210,
        hp: 56, cost: 88, wage: 6,
      ...
      { id: "mongolia_khansguard", name: "Khan's Guard", role: "elite",
  ...
  rus: {
    ...
    troops: [
      ...
      { id: "rus_luchniki", name: "Luchniki", role: "specialist",
      ...
      { id: "rus_druzhinnik", name: "Druzhinnik", role: "elite",
        attack: 13, defense: 6, speed: 195, evasion: 4, range: 0,
        hp: 88, cost: 111, wage: 7,
  ...
  arabia: {
    ...
    troops: [
      { id: "arabia_jundi", name: "Jundi", role: "line",
        attack: 8, defense: 5, speed: 140, evasion: 2, range: 0,
        hp: 50, cost: 32, wage: 2,
      ...
      { id: "arabia_ghulam", name: "Ghulam", role: "elite",
        attack: 12, defense: 9, speed: 130, evasion: 4, range: 210,
        hp: 74, cost: 85, wage: 5,
      ...
      { id: "arabia_hajjana", name: "Hajjana", role: "specialist",
        attack: 10, defense: 2, speed: 195, evasion: 14, range: 0,
        hp: 62, cost: 88, wage: 6,
      ...
      { id: "arabia_saqqa", name: "Saqqa", role: "specialist",
        attack: 13, defense: 5, speed: 158, evasion: 24, range: 0,
        hp: 48, cost: 62, wage: 4,
  ...
  viking: {
    ...
    troops: [
      { id: "viking_raider", name: "Raider", role: "line",
        attack: 8, defense: 2, speed: 150, evasion: 2, range: 0,
        hp: 50, cost: 32, wage: 2,
      ...
      { id: "viking_huscarl", name: "Huscarl", role: "elite",
        attack: 13, defense: 9, speed: 130, evasion: 4, range: 0,
        hp: 80, cost: 85, wage: 5,
      ...
      { id: "viking_berserker", name: "Berserker", role: "specialist",
      ...
      { id: "viking_skjaldmaer", name: "Skjaldmaer", role: "specialist",
        attack: 10, defense: 2, speed: 168, evasion: 14, range: 0,
        hp: 54, cost: 62, wage: 4,
  ...
  persia: {
    ...
    troops: [
      { id: "persia_sparabara", name: "Sparabara", role: "line",
      ...
      { id: "persia_immortal", name: "Immortal", role: "elite",
        attack: 13, defense: 6, speed: 140, evasion: 4, range: 0,
        hp: 80, cost: 85, wage: 5,
      ...
      { id: "persia_medianhorse", name: "Median Horse", role: "specialist",
        attack: 10, defense: 2, speed: 195, evasion: 14, range: 0,
        hp: 62, cost: 88, wage: 6,
      ...
      { id: "persia_scythedchariot", name: "Scythed Chariot", role: "specialist",
  ...
  india: {
    ...
    troops: [
      { id: "india_bhata", name: "Bhata", role: "line",
        attack: 8, defense: 2, speed: 150, evasion: 2, range: 0,
        hp: 50, cost: 32, wage: 2,
      ...
      { id: "india_padaraksha", name: "Padaraksha", role: "elite",
      ...
      { id: "india_dhanurdhara", name: "Dhanurdhara", role: "specialist",
        attack: 9, defense: 5, speed: 158, evasion: 14, range: 210,
        hp: 48, cost: 62, wage: 4,
      ...
      { id: "india_ulmuka", name: "Ulmuka", role: "specialist",
  ...
  egypt: {
    ...
    troops: [
      { id: "egypt_menfyt", name: "Menfyt", role: "line",
      ...
      { id: "egypt_strongarm", name: "Strong-Arm", role: "elite",
        attack: 13, defense: 9, speed: 130, evasion: 4, range: 0,
        hp: 80, cost: 85, wage: 5,
      ...
      { id: "egypt_seneny", name: "Seneny", role: "specialist",
      ...
      { id: "egypt_medjay", name: "Medjay", role: "specialist",
        attack: 10, defense: 2, speed: 168, evasion: 14, range: 0,
        hp: 54, cost: 62, wage: 4,
  ...
  kush: {
    ...
    troops: [
      { id: "kush_tasetibowman", name: "Ta-Seti Bowman", role: "line",
      ...
      { id: "kush_kandakesshieldman", name: "Kandake's Shieldman", role: "elite",
        attack: 12, defense: 9, speed: 130, evasion: 4, range: 210,
        hp: 74, cost: 85, wage: 5,
      ...
      { id: "kush_musawwaratelephant", name: "Musawwarat Elephant", role: "specialist",
      ...
      { id: "kush_butanahunter", name: "Butana Hunter", role: "specialist",
        attack: 9, defense: 2, speed: 168, evasion: 14, range: 210,
        hp: 48, cost: 62, wage: 4,
  ...
  aztecs: {
    ...
    troops: [
      { id: "aztecs_yaoquizqui", name: "Yaoquizqui", role: "line",
        attack: 8, defense: 5, speed: 140, evasion: 2, range: 0,
        hp: 50, cost: 32, wage: 2,
      ...
      { id: "aztecs_ocelotl", name: "Ocelotl", role: "elite",
        attack: 13, defense: 6, speed: 140, evasion: 4, range: 0,
        hp: 80, cost: 85, wage: 5,
      ...
      { id: "aztecs_cuauhtli", name: "Cuauhtli", role: "specialist",
        attack: 9, defense: 2, speed: 168, evasion: 14, range: 210,
        hp: 48, cost: 62, wage: 4,
      ...
      { id: "aztecs_cuachic", name: "Cuachic", role: "specialist",
        attack: 10, defense: 2, speed: 168, evasion: 14, range: 0,
        hp: 54, cost: 62, wage: 4,
  ...
  inca: {
    ...
    troops: [
      { id: "inca_mitayuq", name: "Mit'ayuq", role: "line",
        attack: 7, defense: 2, speed: 150, evasion: 2, range: 210,
        hp: 44, cost: 32, wage: 2,
      ...
      { id: "inca_awqakamayuq", name: "Awqa Kamayuq", role: "elite",
        attack: 13, defense: 6, speed: 140, evasion: 4, range: 0,
        hp: 80, cost: 85, wage: 5,
      ...
      { id: "inca_waraka", name: "Waraka", role: "specialist",
      ...
      { id: "inca_ayllu", name: "Ayllu", role: "specialist",
